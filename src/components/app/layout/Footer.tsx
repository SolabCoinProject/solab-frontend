        ...
        <div className="footer mt-32">
            ...
            >
                <div className="max-w-7xl mx-auto px-4">
                    <div
                        className="flex flex-col lg:flex-row items-center justify-between py-16 border-b border-solabGray-50">
                        <div>
                            ...
                            <p className="text-solabGray-100">
                                ...
                                other updates by subscribing to <Link href="https://t.me/solabofficial">
                                <a className="underline text-solabCyan-500">
