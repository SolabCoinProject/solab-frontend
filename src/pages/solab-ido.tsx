...
const SolabIDO: NextPage = () => {
    ...
    useEffect(() => {
        if (user) {
            dispatch(solabProjectActions.fetchRegisterInfo({userId: user._id}));
        } else {
            dispatch(
            ...
            <div className="w-11/12 mx-auto">
              ...
              Minutes
                    ...
                    <div className="flex flex-col items-center justify-center">
                        ...
                        <span className="text-solabGray-100 text-xs lg:text-base">Sec</span>
                    </div>
                </div>
            </div>
        );
                ...
                {solabProject ? (
                    ...
                    {getProjectPhraseAndCountDown().status}
                                ...
                                <div className="w-full text-center mt-3">
                                    ...
                                    <div className="mt-2">
                                        {user ? (
                                            !solabProject.followers.includes(user._id) ? (
                                                <button
                                                    type="button"
                                                ...
                                                >
                                                    {isFollowingProject ? '...' : 'Register Now'}
                                                </button>
                                            ) : (
                                                <div
                        ...
                        >
                          IDO SCHEDULE
                                ...
                                Whitelist Registration Start
                                                        ...
                                                        <li className="flex items-center justify-center">
                                                            <GoPrimitiveDot className="color-bg-solabCyan-500 mr-0.5"/>
                                                            <span className="ml-0.5">Social Task</span>
                                                        </li>
                                                    </ul>
                                                    <div
                            ...
                            {' '}
                                                        {format(
                                                            new Date('2021-12-28T02:00:00.000+00:00'),
                                                            'MMMM do yyyy, hh:mm a OOOO'
                                                        )}
                          </span>
                                                </div>
                                                ...
                                                >
                                                    <ul>
                                                        <li className="flex items-center justify-center">
                                                            ...
                                                            <span className="ml-0.5">Prefunding</span>
                                                        </li>
                                                        <li className="flex items-center justify-center">
                                                            <GoPrimitiveDot className="mr-0.5"/>
                                                            <span className="ml-0.5">Social Task</span>
                        ...
                        <span className="text-solabGray-100">
                          ...
                          {solabRegisterInfo ? solabRegisterInfo.tickets : 0}
                        </span>
                                            </h3>
                                            {isAfter(
                                                new Date(),
                                                ...
                                                <div className="bg-solabGray-300 py-6 rounded-lg mt-8">
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            {!isCaptchaDone ? (
                                                                                ...
                                                                                <Formik
                                                                                    ...
                                                                                    initialValues={{
                                                                                        usdcAmount:
                                                                                            solabProject.buyAmountOptions[0],
                                                                                    }}
                                                                                    onSubmit={async (
                                                                                        values,
                                                                                        {setSubmitting}
                                                                                            ...
                                                                                            <Form>
                                                                                                <div
                                                                                                    ...
                                                                                                    <p className="text-xs italic text-solabGray-100">{`You will receive ${
                                                                                                        values.usdcAmount == 100
                                                                                                            ? 10
                                                                                                            : values.usdcAmount == 200
                                                                                                                ? 25
                                                                                                                : values.usdcAmount == 300
                                                                                                                    ? 50
                                                                                                                    : 0
                                                    ...
                                                    transaction!
                                                                                                ...
                                                                                                <ul className="list-disc p-4">
                                                                                                    <li>
                                                    <span>
                                                      This prefund amount will
                                                      be used for 2 purpose:{' '}
                                                    </span>
                                                        ...
                                                        <span>
                                                          ...
                                                          your wallet:
                                                                        ...
                                                                        solabRegisterInfo.isInWhiteList === 1 ? (
                                          ...
                                          {' '}
                                            ...
                                            registered wallet.
                                                                                ...
                                                                                <li className="flex items-center justify-center">
                                                                                    <GoPrimitiveDot/>
                                                                                    <span>
                                            Follow @solabofficial for the latest
                                            updates!
                                          </span>
                                                                                </li>
                                                                            </ul>
                                                                    ...
                                                                    <>
                                                                        {isAfter(
                                                                            ...
                                                                            <>
                                                                                {' '}
                                                                                <h3 className="text-yellow-500 text-xl">
                                                                                    Note: Make sure your kyc verified in
                                                                                    order to register!
                                                                                </h3>
                                                                                <button
                                                                                    ...
                                                                                    onClick={() => {
                                                                                        router.push({
                                                                                            pathname: routes.app.myAccount,
                                                                                        });
                                                                                    }}
                                                                                >
                                                                                    Click here to check your KYC!
                                                                                </button>
                                                                            </>
                                                                        )}
                                                                    </>
                                            ...
                                            {isBefore(
                                                ...
                                                <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-4">
                                                    <div className="rounded-lg bg-solabGray-300 p-4">
                                                        ...
                                                        <div className="mt-4">
                                                            {solabProject && solabProject.task
                                                                ? solabProject.task
                                                                    .filter(
                                                                        (t) =>
                                                                            t.taskType ===
                                            ...
                                            <span className="whitespace-nowrap">
                                              ...
                                              Wallet is not connected
                                                    ...
                                                    <div className="rounded-lg bg-solabGray-300 p-4">
                                                        ...
                                                        <p className="mt-4 test-sm">
                                                            You can collect tickets by inviting your friends
                                                        ...
                                                        <div className="flex items-center mt-4 gap-4">
                                                            ...
                                                            <button
                                                                ...
                                                                onClick={() => {
                                                                    copy(
                                                                        getRefLink() ? (getRefLink() as string) : ''
                                                                    );
                                                                    toast.success(
                                                        ...
                                                        <p className="mt-6 text-sm">Rules</p>
                                                        <ul className="list-disc px-4 text-sm">
                                                            <li>
                                                                Get 3 tickets when your friends successfully
                                                                registered this project.
                                                            </li>
                                                            <li>
                                                                Get 7 tickets when your friends have been
                                                                completed Commit USDC step.
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                    ...
                                    <Tab.Panel className="overflow-x-auto">
                                        ...
                                        >
                                            <TabList
                                                ...
                                                {solabProject.details?.map((detail) => (
                                                    <ReactTab
                          ...
                          <span className="text-solabGray-100 text-sm">
                            Token distribution
                                                    ...
                                                    <span className="text-sm">
                            {format(
                                new Date(solabProject.firstPayment.date),
                                'MMMM do yyyy, hh:mm a OOOO'
                            )}
                          </span>
                                                </div>
