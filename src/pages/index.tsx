...
const Home: NextPage = () => {
  ...
  return (
    <Container>
          ...
          <div className="grid lg:grid-cols-7 auto-cols-fr">
            <div className="col-span-4">
              <h1 className="text-solabWhite-500 text-3xl sm:text-4xl">
                ...
                <span className="font-medium leading-4"> on Solana</span>
              </h1>
              <p className="text-base w-4/5 text-solabGray-100">
                ...
                guaranteed allocations, token vesting, token generator, an NFT
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-3 auto-rows-fr gap-8">
            <div className="text-center border border-solabGray-50 py-4">
              ...
              <p className="text-sm text-solabGray-100">SOLAB STAKED</p>
            </div>
            <div className="text-center border border-solabGray-50 py-4">
              <h1 className="text-solabCyan-500 text-2xl lg:text-3xl">
                <NumberFormat
              ...
              <p className="text-sm text-solabGray-100">TOTAL VALUE STAKED</p>
            </div>
            <div className="text-center border border-solabGray-50 py-4">
              <h1 className="text-solabCyan-500 text-2xl lg:text-3xl">
                <NumberFormat
      ...
      <div className="mt-32 px-4">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-center text-3xl font-bold">Tiered System</h1>
          <div className="mt-12">
                      ...
                      <div className="bg-solabGray-300 rounded-lg border border-solabGray-50 pb-5">
                        ...
                        <div className="mt-8 px-4 text-sm lg:text-base">
                          <div className="flex justify-between items-center">
                            <span className="font-bold">Lottery tickets</span>
                            <span className="text-solabGray-100">
      ...
      <div className="mt-32 px-4">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-center text-3xl font-bold">Media Partners</h1>
          <Swiper
            pagination={{
              clickable: true,
            }}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-8">
            <VerticalTimeline animate={false}>
              ...
              >
                <h3 className="text-2xl text-solabCyan-500">Dec, 2021</h3>
                <ul className="list-disc pl-5">
                  <li className="text-base">Tier system release</li>
                  <li className="text-base">First Solab Project launch</li>
                  <li className="text-base">
                    Airdrop + Whitelist lottery registration opens
                  </li>
                  <li className="text-base">KYC Integration</li>
                </ul>
              </VerticalTimelineElement>
              <VerticalTimelineElement
                className="vertical-timeline-element--work vertical-timeline.vertical-timeline-custom-line"
                ...
                iconClassName="bg-solabCyan-500 text-yellow-500 w-4 h-4"
              >
                <h3 className="text-2xl text-solabCyan-500">Q1, 2022</h3>
                <ul className="list-disc pl-5">
                  <li className="text-base">
                    SOLAB trading now live on Raydium
                  </li>
                  <li className="text-base">Partnership development</li>
                </ul>
              </VerticalTimelineElement>
              <VerticalTimelineElement
                className="vertical-timeline-element--work vertical-timeline.vertical-timeline-custom-line"
                ...
                iconClassName="bg-solabCyan-500 text-yellow-500 w-4 h-4"
              >
                <h3 className="text-2xl text-solabCyan-500">Q2, 2022</h3>
                <ul className="list-disc pl-5">
                  <li className="text-base">Token Swap feature release</li>
                  <li className="text-base">NFT marketplace</li>
                </ul>
              </VerticalTimelineElement>
              <VerticalTimelineElement
                className="vertical-timeline-element--work vertical-timeline.vertical-timeline-custom-line"
                ...
                iconClassName="bg-solabCyan-500 text-yellow-500 w-4 h-4"
              >
                <h3 className="text-2xl text-solabCyan-500">Q3, 2022</h3>
                <ul className="list-disc pl-5">
                  <li className="text-base">Solab game studio release</li>
              ...
              <VerticalTimelineElement
                ...
                iconClassName="bg-solabCyan-500 text-yellow-500 w-4 h-4"
              >
                <h3 className="text-2xl text-solabCyan-500">Q4, 2022</h3>
                <ul className="list-disc pl-5">
                  <li className="text-base">Mobile App development</li>
                </ul>
              </VerticalTimelineElement>
            </VerticalTimeline>
          </div>
